...
class SliverFillRemainingBoxAdapter extends SingleChildRenderObjectWidget {
  ...
  RenderSliverFillRemainingBoxAdapter createRenderObject(BuildContext context) {
    ScrollableState scrollable = context.findAncestorStateOfType<ScrollableState>() ?? ScrollableState();
    return RenderSliverFillRemainingBoxAdapter(scrollable.widget.controller ?? ScrollController());
  }
}
